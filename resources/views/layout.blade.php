    ...
    <div class="content">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="{{ route('account.index') }}" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary">SMAS</h3>
                </a>
            ...
            <div class="bg-light rounded-top p-4">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 text-center text-sm-end">
                        Designed By <a href="https://www.facebook.com/profile.php?id=100005592406638">Thanh Nhan Le - 001272787</a>
                    </div>
                </div>
            </div>
        </div>
